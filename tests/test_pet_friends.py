...
def test_get_api_key_for_valid_user(email=valid_email, password=valid_password):
    """ Проверяем что запрос api ключа возвращает статус 200, а в результате выдачи на запрос есть слово key"""
...
def test_successful_delete_self_pet():
    ...
    # Проверка: если список своих питомцев пустой, то добавляем нового и опять запрашиваем список своих питомцев:
